...
<modules>
	<module version="0.1">com.chatwork.ac2013.timods</module>
</modules>
...
For example,
	...
	var my_module = require('com.chatwork.ac2013.timods');
	my_module.foo();
...
To create a module, create a file named com.chatwork.ac2013.timods.js under the assets folder.
